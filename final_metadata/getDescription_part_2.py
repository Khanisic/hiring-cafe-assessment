...
INPUT_FILE = 'split_job_titles/job_titles_with_title_part_2.json'
OUTPUT_FILE = 'output_jsons/jobs_with_metadata_part_2.json'
...
def get_job_data(url):
    ...
    try:
        ...
        desc_el = None
        keywords = ["Description & Requirements", "Opportunity", "Job Overview", "Descriptions", "Your challenges and objectives:","#WinningRequirements","#YourRole","#YourOpportunity"]
